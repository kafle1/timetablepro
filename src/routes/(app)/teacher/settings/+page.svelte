<!-- src/routes/(app)/teacher/settings/+page.svelte -->
<script lang="ts">
  ...
  import { Bell, Lock, Eye, Globe, Moon } from 'lucide-svelte';
  ...
  async function loadData() {
    try {
      ...
      if (currentTeacher.preferences) {
        settings = {
          ...settings,
          ...currentTeacher.preferences
        };
      }
    } catch (err) {
  ...
  async function handleUpdateSettings() {
    ...
    try {
      await updateUser(currentTeacher.$id, {
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-muted-foreground">Get notified about schedule changes</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-muted-foreground">Receive announcements</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
